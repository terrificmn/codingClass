...
**python을 설치하지 말고** python-is-python3 로 설치를 하자. 기존에 python3 는 당연히 설치가 되어 있음.   

TODO:   
> 처음 설치해 봤을 때는 python2 관련 패키지를 설치했지만 python 필요없는 듯 하고    
python-is-python2 도 필요 없을 듯 하다.  python-is-python3 로 설치해서 해보자   
