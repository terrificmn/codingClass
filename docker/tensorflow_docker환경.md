...
```
파일질라에서 다운로드 할 수도 있지만. (최신버전 3.54, yum 리포지터리는 3.49)
yum으로 받는게 편하다.. 디펜던시도 해결해주니깐 ㅋㅋ
...
끝!! 참고로 용량은 최초 5기가 정도에서 8기가 정도를 더 사용하게 됨.... 용량을 많이 차지하네;;
현재 약 13기가 정도 사용하고 있으면 43.9% 사용 중..
용량 30기가 넘으면 과금되므로 모니터링 잘 하자~ 
